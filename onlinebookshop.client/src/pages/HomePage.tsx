...
//    color: #fff;
//}
//.hero-slide-title { font-weight: 700; font-size: 18px; }
//.hero-slide-subtitle { font-size: 13px; opacity: 0.85; }
//.hero-slider-dots {
//    position: absolute;
...
//                            {/* Right — Banner slider (fallback to CSS book mockup if no banners) */}
//                            <div className="col-lg-6 d-none d-lg-block">
//                                {banners.length > 0 ? (
...
//                                            Academic &amp; Reference
//                                        </div>
//                                        <div className="hb hb-1"><span className="hb-title">Classic Fiction</span></div>
//                                        <div className="hb hb-2"><span className="hb-title">Bestseller 2025</span></div>
//                                        <div className="hb hb-3"><span className="hb-title">Islamic Books</span></div>
//                                    </div>
//                                )}
//                            </div>
